...
These are then loaded via the initializer script in `config/initializers/authlogic_connect_config.rb`:
    ...
    Passport.config = YAML.load_file("config/authlogic.yml")
...
There are 3 ways you a user can login with Passport:
...
*	**Passport Example Project:** [http://github.com/viatropos/authlogic-connect-example](http://github.com/viatropos/authlogic-connect-example)
